<template>
  <section class="d-flex row container pb-5" id="accountParam">
    ...
    <div class="col-4 d-flex flex-column justify-content-around mb-5">
      <h3>Messages de la rubrique "Nous Contacter"</h3>

      <!--MODAL - GET USER ISSUES FROM "Nous Contacter"-->
      <b-button v-b-modal.allIssues @click="getIssues(), getPending()" variant="info" class="m-auto rounded-pill">Voir les messages</b-button>
    ...
    <div class="col-4">
      ...
      <b-button v-b-modal.allReports @click="getAllReports(), isClicked = true" variant="info" class="rounded-pill">Voir les signalements</b-button>
              ...
              <div v-for="(postReport, index) in allReports.postReports" :key="index">
                <b-list-group>
                  ...
                  <b-list-group-item button class="d-flex m-auto" v-b-toggle="reportPostId(index)" @click="getUserInfo(index), getPost(index)">
                    ...
                    <p class="d-flex col-6 justify-content-center pending" v-if="allReports.postReports[index].status === 'pending'">En attente de traitement</p>
                    <p v-else class="d-flex col-6 justify-content-center treated">Traité</p>
                    <p class="openBtn col-4">Ouvrir</p>
                  </b-list-group-item>
            ...
            <div v-if="allReports.commentReports.length > 0">
              <div v-for="(commentReport, indexComment) in allReports.commentReports" :key="indexComment">
                <b-list-group>
                  ...
                  <!--TOGGLE - GET REPORT-->
                  <b-list-group-item button class="d-flex m-auto" v-b-toggle="reportCommentId(indexComment)" @click="getUserInfoComment(indexComment), getComment(indexComment)">
                    <h4 class="col-2">N°{{ allReports.commentReports[indexComment].id }}</h4><br>
                    <!--COMMENTS REPORTS STATUS-->
                    <p class="d-flex col-6 justify-content-center pending" v-if="allReports.commentReports[indexComment].status === 'pending'">En attente de traitement</p>
                    <p v-else class="d-flex col-6 justify-content-center treated">Traité</p>
                    <p class="openBtn col-4">Ouvrir</p>
                  </b-list-group-item>
                    ...
                    <b-card class="d-flex flex-column m-auto">
                      <div class="border p-2">
                        ...
                        <b-collapse :id="'comment' + indexComment" class="mt-3 mb-5">
                          <div class="col-12 row justify-content-sm-between align-items-center comment ml-0 mr-0 mb-3">
                            ...
                            <div class="commentText">{{ comment.infos.comment }}</div>
                          </div>
                          ...
                          <b-sidebar id="sidebar-1" title="Aperçu post/commentaires">
                            <div class="d-flex m-auto flex-column col-12 align-items-center">
                            ...
                            <div class="d-flex m-auto flex-column col-12 align-items-center">
                              ...
                              <div class="col-12 row justify-content-sm-between align-items-center comment ml-0 mr-0 mb-3" v-for="(contextComment, indexComment) in context.comments" :key="indexComment">
                                <div class="userComment d-flex flex-column">
                                ...
                                <div class="commentText">{{ contextComment.comment }}</div>
                              </div>
                            </div>
                          </b-sidebar>
                        </b-collapse>
                      ...
                      <div>
                        ...
                        <div class="d-flex flex-column border p-2">
                          ...
                          <div class="accordion" role="tablist">
                                ...
                                <b-card-body>
                                  <b-form enctype="multipart/form-data">
                                    <b-form-group>
                                      ...
                                      <b-button type="submit" @click.prevent="updateComment(indexComment)" class="commentBtn">Modifier</b-button>
                                    </b-form-group>
                                  </b-form>
                                </b-card-body>
                              </b-collapse>
                            ...
                            <b-button block v-b-toggle.accordion-2 variant="danger" @click="deleteComment(indexComment)">Supprimer le commentaire signalé</b-button>
                          </div>
                        </div>
    ...
    <div class="col-4">
      <h3>Utilisateurs</h3>
      <b-button @click="getAllUsers" v-b-modal.allUsers class="rounded-pill" variant="info">Voir tous les utilisateurs</b-button>
      <b-modal ok-only ok-title="Fermer" ok-variant="warning" id="allUsers" title="Tous les utilsateurs">
        <div class="my-4 d-flex row align-items-center col-12 justify-content-between" v-for="user in allUsers" :key="user.id">
